...
# file = "./results/1_most_similar/expression_matrix_problem_illness.dat", sep = "\t",
#             col.names = F, row.names = F)
# problem control
index_problem_control <- "E72" 
...
# file = "./results/1_most_similar/expression_matrix_problem_control.dat", sep = "\t",
#             col.names = F, row.names = F)
# expression matrix for the
indexes_problem <- "C110|E72"
...
# file = "./results/1_most_similar/expression_matrix_to_reoa.dat", sep = "\t",
#             col.names = F, row.names = F)
