...
expression_matrix_problem_illness = expression_matrix_problem_illness[, rep(1, each=3)]
# write.table(x = expression_matrix_problem_illness,
# file = "./results/expression_mats/5_three_samples/expression_matrix_problem_illness.dat", sep = "\t",
#             col.names = F, row.names = F)
# problem control
index_problem_control <- "E72|C20|C2" 
...
# file = "./results/expression_mats/5_three_samples/expression_matrix_problem_control.dat", sep = "\t",
#             col.names = F, row.names = F)
# expression matrix for the
indexes_problem <- "C110|E72|C20|C2"
...
# file = "./results/expression_mats/5_three_samples/expression_matrix_to_reoa.dat", sep = "\t",
#             col.names = F, row.names = F)
### Annotation curation
