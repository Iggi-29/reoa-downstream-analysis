...
### get the patient with the highest accumulated correlation
row_sums <- sort(rowSums(pearson.cor),decreasing = T)
print((row_sums)[1:3])
...
# file = "./results/expression_mats/2_most_similar_to_all/expression_matrix_problem_illness.dat", sep = "\t",
#             col.names = F, row.names = F)
# problem control
index_problem_control <- "E55" 
...
# file = "./results/expression_mats/2_most_similar_to_all/expression_matrix_problem_control.dat", sep = "\t",
#             col.names = F, row.names = F)
# expression matrix for the
indexes_problem <- "C110|E55"
...
# file = "./results/expression_mats/2_most_similar_to_all/expression_matrix_to_reoa.dat", sep = "\t",
#             col.names = F, row.names = F)
